...
class AdminOrdersController extends AdminOrdersControllerCore
{
    ...
    {
        parent::__construct();
        $this->bulk_actions['ShippingListDPD'] = [ 'text' => $this->l('Print DPD Shipping List'), 'icon' => 'icon-th-list'];
        $this->bulk_actions['PrintDPD'] = [ 'text' => $this->l('Print DPD Label'), 'icon' => 'icon-print'];
    }
    ...
    public function processBulkPrintDPD()
    {
        if (Tools::isSubmit('submitBulkPrintDPDorder')) {
            ...
            $params = ['token' => Tools::getAdminTokenLite('AdminDpdLabels')] ;
    ...
    public function processBulkShippingListDPD()
    {
        if (Tools::isSubmit('submitBulkShippingListDPDorder')) {
            $id_lang = Context::getContext()->language->id;
            $params = ['token' => Tools::getAdminTokenLite('AdminDpdShippingList')] ;
