...
class HTMLTemplateDPDShippingList extends HTMLTemplate
{
    ...
    public function getHeader()
    {
        ...
        return $this->smarty->fetch(_PS_MODULE_DIR_ . 'dpdconnect' . DS . 'pdf' . DS . 'header.tpl');
    }

    public function getContent()
    {
        return $this->smarty->fetch(_PS_MODULE_DIR_ . 'dpdconnect' . DS . 'pdf' . DS . 'content.tpl');
    }
    ...
    {
        return _PS_MODULE_DIR_ . 'dpdconnect' . DS . 'logo.png';
    }
    ...
    {
        return $this->smarty->fetch(_PS_MODULE_DIR_ . 'dpdconnect' . DS . 'pdf' . DS . 'pagination.tpl');
    }
}
